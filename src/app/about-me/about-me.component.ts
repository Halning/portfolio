...
@Component({
  ...
  animations: [
    ...
    trigger('print', [
      ...
      transition(':enter', [animate(2000, style({ width: '100%', transform: 'steps(100, end)' }))]),
    ...
    trigger('alive', [
      ...
      transition(':enter', [animate(800, style({ opacity: 1, transform: 'scale(1)' }))]),
...
export class AboutMeComponent implements OnInit {
  ...
  private initMetaTags(): void {
    this.meta.updateTag({ name: 'description', content: 'About myself: Halning experience information' });
  }
}
