...
//           });
//           logServiceSpy.debug();
//           expect(logApiServiceSpy.sendDebugMessage).toHaveBeenCalledWith(
//             expectedLogMessage,
//           );
//           expect(logApiServiceSpy.sendDebugMessage).toHaveBeenCalledTimes(1);
//         });
...
//               'Some primary debug message. {"someKey":"some value"}';
//             const expectedLogMessage = new LogMessage({
//               source: LogMessage.Source.ADF,
//               content: expectedContent,
//             });
//             logServiceSpy.debug('Some primary debug message', {
//               someKey: 'some value',
//             });
//             expect(logApiServiceSpy.sendDebugMessage).toHaveBeenCalledWith(
//               expectedLogMessage,
