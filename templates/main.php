<div class="main home">
    <div class="jumbotrom full-image">
        <div class="container">
            <h1>I am <span>Andrei</span></h1>
            <h2>Full stack developer</h2>
            <a class='read-more'>read more</a>
        </div>
    </div>

    <div class="start_reading container">
        <div class="container start_reading">

            <p>
                <span class="large-letter">М</span>
                <span class="capital-letter">еня зовут Андрей Хоменко.</span> Я Full Stack программист. Я люблю кодить и
                вот мой путь.
            </p>
            <h2>Этап 1&nbsp;&nbsp;<span>&nbsp;&nbsp;Начало пути.</span></h2>
            <h4>Декабрь 2014 – Август 2015</h4>
            <p>
                ...
                <a href="https://github.com/Halning/brovary" target="_blank">https://github.com/Halning/brovary</a>.
                К сожалению проект не был до конца реализован так как наступил Этап 2.
            </p>

            <h2>Этап 2&nbsp;&nbsp;<span>&nbsp;&nbsp;Первая работа</span></h2>
            <h4>Август 2015 – Июнь 2016</h4>
            <p>
                Компания <a href="http://makewear.club/" target="_blank">MakeWear</a>.
            ...
            <p>
                ...
                Использовал Bootstrap, LESS , Query, Query UI, Pjax, Google API а так же AJAX и JSON для общения с
                сервером.
                Серверная часть реализовывалась на PHP в связке с MySQL.В это же время познакомился с Gulp и начал его
                использовать.
            </p>
            <p>
                В последние месяцы выполнял много задач по разработки Акции компании от верстки до серверной части.
                А также в свободное время проходил курс CS50 - <a href="https://cs50.harvard.edu/" target="_blank">https://cs50.harvard.edu/</a>.
                    В компании работал в
                scrum-команде.
                Есть небольшой опыт в DevOps и Azure.
            </p>

            <h2>Этап 3&nbsp;&nbsp;<span></span>&nbsp;&nbsp;Осознание</h2>
            <h4></h4>
            <p>
                В Июне закончил курс CS50 и стал более глубоко изучать JavaScript.
                От состояния “мне нравиться JavaScript” перешел к “я люблю JavaScript”.
                С этих пор и до этого дня я учу его и все что с ним связано. В первую очередь Angular 1.x.
                В данный момент изучаю Angular 2.
            </p>
            <figure class="ornament">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px"
                     y="0px" viewBox="0 0 77.5 45.5" enable-background="new 0 0 77.5 45.5" xml:space="preserve">
                    <style>
                        .style0 {
                            fill: #333333;
                        }
    ...
    <div class="footer">
        <div class="container">
            <ul>
                ...
                <li>
                    <a href="pages/skils.html">Навыки</a>
                </li>
                <li>
                    <a href="pages/projects.html">Проэкты</a>
                </li>
                <li>
